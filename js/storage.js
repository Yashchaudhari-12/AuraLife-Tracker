...
const STORAGE_KEYS = {
    ...
    TASKS: 'auralife_tasks',
    TODAYS_FOCUS: 'auralife_todays_focus',
    FOCUS_DATE: 'auralife_focus_date',
    MILESTONE_GOALS: 'auralife_milestone_goals_v2',
    HABITS: 'auralife_habits_v2',
    CODING_STATS: 'auralife_coding_stats_v1',
    XP: 'auralife_xp',
    ACTIVITY_LOG: 'auralife_activity_log',
    CALENDAR_NOTES: 'auralife_cal_notes',
    LOGS: 'auralife_logs',
...
export const Storage = {
    ...
    getSubjects() { return readJSON(STORAGE_KEYS.SUBJECTS, DEFAULT_SUBJECTS); },
    ...
    getGoals() { return readJSON(STORAGE_KEYS.GOALS, DEFAULT_GOALS); },
    saveGoals(goals) {
    ...
    getFeatureData() {
        ...
        FEATURE_KEYS.forEach(key => {
            ...
            if (value !== null) {
                ...
                catch (e) { console.error(`Skipping invalid stored data for ${key}`, e); }
            }
        });
    ...
    clearAll() {
        FEATURE_KEYS.forEach(key => localStorage.removeItem(key));
        this._scheduleSync();
    },
