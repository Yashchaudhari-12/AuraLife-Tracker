...
import { SchedulingPreferencesCard } from './SchedulingPreferencesCard';
...
export function SettingsView() {
  ...
  const handleResetData = () => {
    if (window.confirm('Are you sure you want to reset planner local data? Custom focus blocks will be restored to defaults.')) {
      ...
      localStorage.removeItem('auralife_scheduling_preferences');
  ...
  return (
    <div className="space-y-8">
      {/* 1. SUSTAINABILITY & SCHEDULING INTELLIGENCE PREFERENCES */}
      <SchedulingPreferencesCard />

      {/* 2. GENERAL SYSTEM PREFERENCES */}
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-5">
          <div>
            ...
            <h2 className="text-2xl font-bold text-white flex items-center gap-2.5 mt-1">
              ...
              AuraLife General Configuration
            </h2>
          </div>
          {savedSuccess && (
